...
--- TAB_PESSOA 
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (1, '11122233344', 'Carlos Alberto Silva', TO_DATE('1985-03-15', 'YYYY-MM-DD'), 'M', '15991112222', 'CASADO', '123456789012345', 'carlos.silva@apae.org', 'ATIVO');
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (2, '22233344455', 'Ana Beatriz Rocha', TO_DATE('1990-07-22', 'YYYY-MM-DD'), 'F', '15992223333', 'SOLTEIRO', '234567890123456', 'ana.rocha@apae.org', 'ATIVO');
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (3, '33344455566', 'Ricardo Souza Melo', TO_DATE('1978-11-05', 'YYYY-MM-DD'), 'M', '15993334444', 'DIVORCIADO', '345678901234567', 'contato@vivavozfono.com.br', 'ATIVO');
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (4, '44455566677', 'Juliana Lima Costa', TO_DATE('1988-05-30', 'YYYY-MM-DD'), 'F', '15994445555', 'CASADO', '456789012345688', NULL, 'ATIVO');
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (5, '55566677788', 'Marcos Paulo Vieira', TO_DATE('1982-01-25', 'YYYY-MM-DD'), 'M', '15995556666', 'SOLTEIRO', '567890123456789', 'marcos.vieira@gmail.com', 'ATIVO');
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (6, '66677788899', 'Kauã Lucas Ferreira', TO_DATE('2018-04-12', 'YYYY-MM-DD'), 'M', '15996667777', 'SOLTEIRO', '678901234567890', NULL, 'ATIVO');
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (7, '77788899900', 'Mariana Dias Gomes', TO_DATE('2019-09-18', 'YYYY-MM-DD'), 'F', '15997778888', 'SOLTEIRO', '789012345678901', NULL, 'ATIVO');
INSERT INTO tab_pessoa (idcadastro, cpf, nome, datanascimento, sexo, celular, estadocivil, numcns, email, statuscadastro) VALUES (8, '88899900011', 'Pedro Henrique Antunes', TO_DATE('2017-01-30', 'YYYY-MM-DD'), 'M', '15998889999', 'SOLTEIRO', '890123456789012', NULL, 'ATIVO');
